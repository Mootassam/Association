...
import actions from 'src/modules/newsTag/list/newsTagListActions';
...
function NewsTagToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    newsTagSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    newsTagSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="news-tag-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="news-tag-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="news-tag-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="news-tag-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=newsTag">
          <span
